...
% 设置图片的 caption 格式 这里不能用加粗也不能用楷体
\renewcommand{\thefigure}{\thesection-\arabic{figure}}
\captionsetup[figure]{labelsep=space,skip=10bp}

% 设置表格的 caption 格式 这里不能用加粗也不能用楷体
\renewcommand{\thetable}{\thesection-\arabic{table}}
\captionsetup[table]{labelsep=space,skip=10bp}
...
\titlespacing\subsubsection{0pt}{0pt plus 2pt minus 2pt}{0pt plus 2pt minus 2pt} % 修改了三级标题前距
